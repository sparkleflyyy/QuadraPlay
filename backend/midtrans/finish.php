...
$logData = date('Y-m-d H:i:s') . " - FINISH - Order: $orderId, Status: $transactionStatus\n";
@file_put_contents($logFile, $logData, FILE_APPEND);

// Redirect ke app menggunakan deep link
$deepLink = "quadraplay://payment/finish?order_id=" . urlencode($orderId) . 
            "&status=" . urlencode($transactionStatus);

// Fallback HTML jika deep link tidak berfungsi
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Pembayaran Berhasil - QuadraPlay</title>
    <style>
